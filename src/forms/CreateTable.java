...
public class CreateTable extends JScrollPane {
    ...
    public JScrollPane table(String table, String[] columnName, String query, Dimension d) {
        ...
        labels = new JLabel[column * row + 1];
        // lay du lieu bang
        ...
        for (int i = 0; i < row; i++) {
            ...
            pnlData[i].setLayout(new GridLayout(0,column));
