...
class SellForm2 extends JFrame {
    public static JTextField tfProductCode,tfCusPey;
    JTextField tfProductName, tfExpirationDate, tfDiscount;
    JTextField tfPrice;
    JTextField tfTotal;
    public static JLabel lblExcessCase_Money;
    public static JLabel lblEmployeeName;
    public static JLabel lblTotal_Money;
    ...
    public SellForm2() {
        ...
        JTextField tftCusName = new JTextField();
...
//
//                        //UPDATE INVENTORY
//                        String query = "update inventory set quantity = quantity - " + table.getValueAt(i, 2) +
//                                " from inventory inner join product " +
//                                "on inventory.productid = product.productid" +
//                                " where code = '" + table.getValueAt(i, 0)+ "'" ;
//                        Statement stmt = con.createStatement();
//                        stmt.executeUpdate(query);
//                    }
//                }catch (Exception a){
    ...
    public static JPopupMenu createYourPopUp(int rowindex, JTable table) {
        ...
        edit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String quantity_new = JOptionPane.showInputDialog(null,"Quantity");
        ...
        delete.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                float tien = 0;
                for (int i = 0; i <= table.getRowCount() - 1; i++) {
                    float tien1 = Float.parseFloat(table.getValueAt(i, 4).toString());
                    tien += tien1;
                }
                lblTotal_Money.setText(String.valueOf(tien));
            }
